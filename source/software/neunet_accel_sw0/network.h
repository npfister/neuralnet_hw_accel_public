...
#define ADVNC_PTR_1			0xa

/* Neural Nework Addresses */
#define ADDR_COMMANDS     (0x0 + NEURAL_NET_ACCELERATOR_0_BASE)
#define ADDR_DATA         (0x4 + NEURAL_NET_ACCELERATOR_0_BASE)
#define ADDR_WEIGHT_H	  (0x8 + NEURAL_NET_ACCELERATOR_0_BASE)
#define ADDR_BIAS_H		  (0xc + NEURAL_NET_ACCELERATOR_0_BASE)
#define ADDR_WEIGHT_O	  (0x10 + NEURAL_NET_ACCELERATOR_0_BASE)
#define ADDR_BIAS_O		  (0x14 + NEURAL_NET_ACCELERATOR_0_BASE)
#define ADDR_PTR		  (0x18 + NEURAL_NET_ACCELERATOR_0_BASE)
#define ADDR_LAYER_SIZE   (0x1c + NEURAL_NET_ACCELERATOR_0_BASE)
